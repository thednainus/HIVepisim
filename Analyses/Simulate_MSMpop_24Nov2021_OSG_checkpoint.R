...
param <- param.net(time.unit = time.unit,
                   ...
                   arrival.age = 18,
                   m12.rate = 1/(10*365),
                   m21.rate = 1.826484e-08)
#m12.rate = 1 in 10 years; we will have 1/(10*365) = 0.0002739726 per day
# for a initial population of 5000 individuals
# to balance number of migrant for m21.rate, we will have x * 15000 = 0.0002739726;
# x = 0.0002739726/15000; x = 1.826484e-08 (per day as m21.rate)
