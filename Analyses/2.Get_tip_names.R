...
sim <- readRDS("Analyses/Preliminary_results/results_tergmLite4/run_8/results_sim.RDS")
...
# working directory
wd <- "Analyses/Preliminary_results/results_tergmLite4/run_8/output/vts"
...
vts_tree <- read.nexus(ali_files[2])
...
tip_names_migrant <- transphylo$seed_480
